  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <Button onClick={() => navigate('/staff/products')}>📦 View Products</Button>
        <Button variant="secondary" onClick={() => navigate('/staff/stock')}>📥 Import Stock</Button>
        <Button variant="secondary" onClick={() => navigate('/staff/stock')}>📤 Export Stock</Button>
        <Button variant="secondary" onClick={() => navigate('/staff/buyers')}>👥 View Buyers</Button>
      </div>
